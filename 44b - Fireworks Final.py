...
class Firework:
    ...
    def __init__(self, x, y, y_vel, explosion_height, color):
        self.x = x
        self.y = y
        self.y_vel = y_vel
...
class Launcher:
    ...
    def launch(self):
        color = random.choice(COLORS)
        explosion_height = random.randrange(50, 400)
        firework = Firework(self.x + self.WIDTH/2, self.y, -5, explosion_height, color)
...
def main():
    ...
    launchers = [
        ...
        Launcher(500, HEIGHT - Launcher.HEIGHT, 5000),
        Launcher(700, HEIGHT - Launcher.HEIGHT, 7000)
